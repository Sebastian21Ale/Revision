 ...
 * 
 */
package co.com.claro.schema.analytics.prmt.request;
...
public class RequesMetric {
	...
	private Integer nofAnCnvrDetJobsId = 0;

	/** Maximum operations per second for details jobs */
	private Integer nofAnCnvrDetJobsRateId = 0;

	/** The absolute maximum content length of a request payload */
	private Integer nofAnCnvrAbsoReqBytes = 0;
	private Integer nofAnCnvrAbsoReqBytesId = 0;

	/**
	 * The maximum number of requests per client credentials grant token per minute
	 */
	private Integer nofAnCnvrCliCredTokenId = 0;

	/**
	 * The maximum number of requests per organization per OAuth client per user per
	 * minute
	 */
	private Integer nofAnCnvrUserRateMinute = 0;
	private Integer nofAnCnvrUserRateMinuteId = 0;

	/** The maximum content length of a request payload */
	private Integer nofAnCnvrReqBytes = 0;
	private Integer nofAnCnvrReqBytesId = 0;

	/** The maximum number of requests per token per minute */
	private Integer nofAnCnvrTokenMinute = 0;
	private Integer nofAnCnvrTokenMinuteId = 0;
